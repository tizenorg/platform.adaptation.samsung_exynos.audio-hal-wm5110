...
typedef struct audio_interface {
    ...
    audio_return_t (*pcm_open)(void **pcm_handle, void *sample_spec, uint32_t direction, void *userdata);
    audio_return_t (*pcm_start)(void *pcm_handle, void *userdata);
    audio_return_t (*pcm_stop)(void *pcm_handle, void *userdata);
    audio_return_t (*pcm_close)(void *pcm_handle, void *userdata);
    audio_return_t (*pcm_avail)(void *pcm_handle, unsigned int *avail, void *userdata);
    audio_return_t (*pcm_write)(void *pcm_handle, const void *buffer, uint32_t frames, void *userdata);
    audio_return_t (*pcm_read)(void *pcm_handle, void *buffer, uint32_t frames, void *userdata);
